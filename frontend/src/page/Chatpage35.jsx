          ...
          <div className="w-96 bg-white shadow-xl border-l border-gray-200 flex flex-col">
            ...
            <div className="p-4 border-b border-gray-100">
              ...
              <div className="relative">
                <select
                  disabled={isLoadingHistory || (serverHistory?.length || 0) === 0}
                  onChange={(e) => {
                    if (e.target.value) {
                      loadConversationFromServer(e.target.value);
                      e.target.value = "";
                    }
                  }}
                ...
                >
                  <option value="">
                    {isLoadingHistory ? 'Loading history...' : (serverHistory?.length ? 'Open a previous conversation...' : 'No saved history')}
                  </option>
