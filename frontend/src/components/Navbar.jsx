...
import { LogOut, Search, BarChart3, Moon, Sun, Database, Wifi, Plug } from 'lucide-react'
import { useUser } from '../context/UserContext'

export function Navbar({ isDarkMode, onToggleDarkMode, isConnectedToDatabase, onOpenDbModal }) {
        ...
        <div className="ml-auto flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2 mr-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 hover:bg-blue-100 text-xs flex items-center"
              title="Connect to MySQL Database"
            >
              <Plug className="h-4 w-4 mr-1" /> Connect DB
            </button>
